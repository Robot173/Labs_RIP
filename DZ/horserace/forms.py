...
class HorseForm(forms.ModelForm):
    class Meta:
        model = models.Horse
        exclude = ['horse_id', 'users']
        widgets = {
            'horse_name': forms.TextInput(attrs={'class': 'form-control'}),
            'horse_owner': forms.TextInput(attrs={'class': 'form-control'}),
            'horse_club': forms.TextInput(attrs={'class': 'form-control'}),
        }
        labels = {
            'horse_name': _('Кличка'),
            'horse_owner': _('Владелец'),
            'horse_club': _('Спортивный клуб'),
            'horse_picture': _('Фотография лошади'),
        }
