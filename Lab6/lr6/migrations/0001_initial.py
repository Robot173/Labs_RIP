# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2017-01-16 11:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='bet',
            name='bet_horse',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lr6.Horse'),
        ),
        migrations.AddField(
            model_name='bet',
            name='bet_user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lr6.User'),
        ),
    ]
